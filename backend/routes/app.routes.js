...
const { homeGet, myprofileGet, newUser, welcomePost, profileGet, GetProfiles, GetImgProfile, PostComment, profileJsonGet, GetComment, PostFriendship, GetFriendsByEmail, GetChat } = require('../controllers/app.controller');
